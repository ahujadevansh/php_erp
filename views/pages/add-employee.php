...
$sidebarSection = 'employee';
    $sidebarSubSection = 'add_employee' ;
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <form action="<?=BASEURL;?>helper/routing.php" method="POST" id="add-employee" enctype="multipart/form-data">
                                    <div class="card-body">
                                        <div class="col-md-12">
...
?>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-6 col-sm-6">
                                                    <label class="text-dark" for="store_id">Store<span class="required">*</span></label>
                                                    <select name="store_id" id="store_id" class="form-control" required>
                                                        <option value="" selected disabled>Select Store</option>
<?php
$stores = $di->get('database')->readData('stores', ["id", "name"], "deleted=0");
...
<?php
if($errors!="" && $errors->has('store_id'))
{
echo "<span class='error'>{$errors->first('store_id')}</span>";
}
?>
                                                </div>
                                                <div class="form-group col-md-6 col-sm-6">
                                                    <label class="text-dark" for="type_id">Employee Designation<span class="required">*</span></label>
                                                    <select name="type_id" id="type_id" class="form-control" required>
                                                        <option value="" selected disabled>Select Employee Designation</option>
<?php
$types = $di->get('database')->readData('employee_type', ["id", "type"], "deleted=0");
...
<?php
if($errors!="" && $errors->has('type_id'))
{
echo "<span class='error'>{$errors->first('type_id')}</span>";
}
?>
                                                </div>
                                            </div>
...
?>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-6 col-sm-6">
                                                    <label for="gender" class="text-dark">Gender<span class="required">*</span></label>
...
?>
                                                ...
                                                <div class="form-group col-md-6 col-sm-6">
                                                    <label for="gender" class="text-dark">Date of birth<span class="required">*</span></label>
...
?>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-6 col-sm-6">
                                                    <label class="text-dark" for="salary">Salary<span class="required">*</span></label>
                                                    <input  type="number" min="0" step="0.01" class="form-control" id="salary" name="salary"
                                                            value="<?=$old != '' && isset($old['salary']) ?$old['salary']: '';?>"
                                                            placeholder="salary">
<?php
if($errors!="" && $errors->has('salary'))
{
echo "<span class='error'>{$errors->first('salary')}</span>";
}
?>
                                                </div>
                                                <div class="form-group col-md-6 col-sm-6">
                                                    <label class="text-dark" for="date_of_joining">Date Of Joining<span class="required">*</span></label>
                                                    <input  type="date" class="form-control" id="date_of_joining"
                                                            value="<?=$old != '' && isset($old['date_of_joining']) ?$old['date_of_joining']: '';?>"
                                                            name="date_of_joining">
<?php
if($errors!="" && $errors->has('date_of_joining'))
{
echo "<span class='error'>{$errors->first('date_of_joining')}</span>";
}
?>
                                                </div>
                                            </div>
...
?>
                                    ...
                                    <div class="card-footer d-flex justify-content-end">
                                        <button type="submit" class="btn btn-primary mb-3" name="page" value="add_employee">Add <i class="fa fa-user-plus px-1"></i></button>
                                    </div>
                                </form>
                            </div>
                        </div>
